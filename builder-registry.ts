...
if (typeof window !== "undefined") {
  ...
  Builder.register("insertMenu", {
    name: "Utilities",
    items: [
      { name: "BlogHeader" }, // Removed LocaleSelector
    ],
  });
}
...
Builder.registerComponent(SplitHero, {
  ...
  inputs: [
    { name: "imageAlignment", type: "string", defaultValue: "right", enum: ["left", "right"], required: true },
    { name: "textAlignment", type: "string", defaultValue: "left", enum: ["left", "center", "right"], required: true },
    { name: "splitWidth", type: "string", defaultValue: "1/2", enum: [{ label: "50 : 50", value: "1/2" }, { label: "1 : 3", value: "1/3" }], required: true },
    { name: "image", type: "file", defaultValue: "https://cdn.builder.io/api/v1/image/assets%2Fa87584e551b6472fa0f0a2eb10f2c0ff%2F0cde6f8ddd9d482fad53266f8ee0f3ce", required: true },
    { name: "altText", type: "string", defaultValue: "blue jeans", required: true },
    { name: "title", type: "longText", defaultValue: "OUR COMMITMENT TO SUSTAINABILITY", required: true },
    { name: "subTitle", type: "richText", defaultValue: "<p>Create impactful, bold silhouettes in our chic, cozy classics</p>" },
    { name: "hasCTA", type: "boolean", defaultValue: false },
    { name: "buttonLink", type: "url", showIf: (options) => options.get("hasCTA") === true, defaultValue: "/" },
    { name: "buttonText", type: "string", showIf: (options) => options.get("hasCTA") === true, defaultValue: "Learn More" },
    { name: "makeFullBleed", type: "boolean", defaultValue: false },
  ],
});
...
Builder.registerComponent(IconCard, {
  ...
  inputs: [
    { name: "alignment", type: "string", enum: ["center", "left", "right"], defaultValue: "center" },
    { name: "altText", type: "string" },
    { name: "coloredBackground", type: "boolean", defaultValue: false },
    { name: "description", type: "richText", defaultValue: "<p>Give developers and marketers an AI-powered platform to quickly transform designs into optimized web and mobile experiences.</p>" },
    { name: "icon", type: "file", defaultValue: "https://cdn.builder.io/static/media/builder-logo.bff0faae.png", required: true },
    { name: "title", type: "string", defaultValue: "Builder.io", required: true },
  ],
});
...
Builder.registerComponent(TextHero, {
  ...
  inputs: [
    ...
    { name: "title", type: "string", defaultValue: "STEP INTO FRESH STYLES", required: true },
  ],
});
...
Builder.registerComponent(ImageHero, {
  ...
  inputs: [
    { name: "title", type: "string", required: true, defaultValue: "SHOP ESSENTIALS" },
    { name: "alignment", type: "string", enum: ["center", "left", "right"], required: true, defaultValue: "center" },
    { name: "backgroundImage", type: "file", required: true, defaultValue: "https://cdn.builder.io/api/v1/image/assets%2Fa87584e551b6472fa0f0a2eb10f2c0ff%2F61c4f304ac9448b1ad741b83de17e48a" },
    { name: "buttonLink", type: "url", required: true, defaultValue: "/" },
    { name: "buttonText", type: "string", required: true, defaultValue: "Shop Now" },
    { name: "subTitle", type: "richText", defaultValue: "<p>Shoppable essentials for your every day life.</p>" },
    { name: "makeFullBleed", type: "boolean", defaultValue: false },
  ],
});
